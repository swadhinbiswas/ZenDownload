  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-zinc-400">
        Install the browser extension to capture downloads and send them directly to ZenDownload.
        Load the <code className="bg-zinc-800 px-1.5 py-0.5 rounded text-xs text-indigo-300">extension/</code> folder as an unpacked extension in Chrome/Edge/Firefox Developer mode.
      </p>
